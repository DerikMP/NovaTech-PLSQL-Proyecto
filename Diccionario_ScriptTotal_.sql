...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "DERIK"."SEQ_CLIENTE"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 61 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Procedure LISTAR_TECNICOS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "DERIK"."LISTAR_TECNICOS" (p_cursor OUT SYS_REFCURSOR) IS
BEGIN
    OPEN p_cursor FOR
        SELECT id_tecnico, nombre, apellido, especialidad, email, telefono
        FROM tecnico;
END;
